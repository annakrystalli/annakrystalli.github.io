...
git subtree pull --prefix=public \
    git@github.com:annakrystalli/annakrystalli.github.io.git origin master -m "Merge origin master"
...
git subtree push --prefix=public \
    git@github.com:annakrystalli/annakrystalli.github.io.git master